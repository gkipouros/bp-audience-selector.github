...
if ( ! class_exists( 'BP_Block_Member_Posting' ) ) {
    ...
    class BP_Block_Member_Posting {
        ...
        public function enqueue_style_scripts() {
            ...
            wp_enqueue_style(
                'bp-audience-selector-core-style',
                BPAS_URL . 'assets/css/bp-audience-selector.css',
                '',
                BPAS_VERSION
            );
            ...
            wp_register_script(
                'bp-audience-selector-custom-script',
                BPAS_URL . 'assets/js/bp-audience-selector.js',
                array(
                    'jquery',
                ),
                BPAS_VERSION,
            ...
            wp_localize_script( 'bp-audience-selector-custom-script', 'BPBMPAjaxObject',
                array(
                    'ajax_url'   => admin_url( 'admin-ajax.php' ),
                    'ajax_nonce' => wp_create_nonce( 'ajax_nonce' ),
                )
            );
            wp_enqueue_script( 'bp-audience-selector-custom-script' );
